...
#define SWIGTYPE_p_DoubleField swig_types[0]
#define SWIGTYPE_p_IntArray swig_types[1]
#define SWIGTYPE_p_IntField swig_types[2]
#define SWIGTYPE_p_StringField swig_types[3]
#define SWIGTYPE_p_UtcDateField swig_types[4]
#define SWIGTYPE_p_char swig_types[5]
#define SWIGTYPE_p_int swig_types[6]
#define SWIGTYPE_p_namespace swig_types[7]
...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__quickfix
...
SWIGINTERN int Swig_var_FIX_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_namespace,  0 );
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""FIX""' of type '""namespace""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""FIX""' of type '""namespace""'");
    } else {
      FIX = *((namespace *)(argp));
    }
  }
...
SWIGINTERN PyObject *Swig_var_FIX_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&FIX), SWIGTYPE_p_namespace,  0 );
  return pyobj;
}
...
static swig_type_info _swigt__p_StringField = {"_p_StringField", "TzTimeStampField *|LocalMktDateField *|DayOfMonthField *|MonthField *|DataField *|ExchangeField *|MultipleCharValueField *|MultipleStringValueField *|TzTimeOnlyField *|CountryField *|MonthYearField *|MultipleValueStringField *|CurrencyField *|StringField *", 0, 0, (void*)0, 0};
...
# endif
  ...
  SWIG_addvarlink(globals, "FIX", Swig_var_FIX_get, Swig_var_FIX_set);
